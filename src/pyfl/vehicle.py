...
class Vehicle():
    ...
    def get_vehicle_arrival(self,registration:list):
        """
        ...
        for item in registration:
            registrations = registrations + f", {item}"
            #TODO: Regex the registration to see if it is valid
        endpoint = f"/Vehicle/{registrations}/Arrivals"
